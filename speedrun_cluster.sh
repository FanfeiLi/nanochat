...
torchrun --standalone --nproc_per_node=1 -m scripts.base_train -- --depth=20 --run=$WANDB_RUN --device_batch_size=16 --num_iterations=100
...
torchrun --standalone --nproc_per_node=1 -m scripts.mid_train -- --run=$WANDB_RUN --device_batch_size=16 --num_iterations=100
...
torchrun --standalone --nproc_per_node=1 -m scripts.chat_sft -- --run=$WANDB_RUN --num_iterations=100
